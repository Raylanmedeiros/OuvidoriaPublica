...
export default function FormularioOuvidoria() {
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-10 bg-gray-200 rounded-lg shadow-[0_0_30px_10px_rgba(0,0,0,0.10)] space-y-6">
